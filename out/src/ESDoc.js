...
var ESDoc = (function () {
  ...
  _createClass(ESDoc, null, [{
    ...
    value: function generate(config, publisher) {
      ...
      _PluginPluginJs2['default'].init(config.plugins);
      _PluginPluginJs2['default'].onStart();
      config = _PluginPluginJs2['default'].onHandleConfig(config);
      ...
      results = _PluginPluginJs2['default'].onHandleTag(results);

      publisher(results, asts, config);

      _PluginPluginJs2['default'].onComplete();
    }
    ...
    value: function _traverse(inDirPath, filePath, packageName, mainFilePath) {
      ...
      try {
        ...
        _UtilInvalidCodeLoggerJs2['default'].showFile(filePath, e);
        return null;
      }

      var pathResolver = new _UtilPathResolverJs2['default'](inDirPath, filePath, packageName, mainFilePath);
      ...
      _UtilASTUtilJs2['default'].traverse(ast, function (node, parent) {
        try {
          ...
          _UtilInvalidCodeLoggerJs2['default'].show(filePath, node);
          throw e;
        }
      });
