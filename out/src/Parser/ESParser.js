...
var ESParser = (function () {
    ...
    _createClass(ESParser, null, [{
        ...
        value: function parse(filePath) {
            ...
            code = _PluginPluginJs2['default'].onHandleCode(code, filePath);
            ...
            parser = _PluginPluginJs2['default'].onHandleCodeParser(parser, option, filePath, code);

            var ast = parser(code);

            ast = _PluginPluginJs2['default'].onHandleAST(ast, filePath, code);
